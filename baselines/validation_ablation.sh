...
DATA_NAME='SUWON_DATASET_VER02-01'
...
#     -p $MODEL_PATH  -m "EVAL/yolov8x_25epochs" \
#     -c $CUDA_DEVICE -i $IMAGE_SIZE  -b $BATCH_SIZE_YOLOv8x  --conf $CONF_SCORE  --iou $IOU_DETECT    --split $SPLIT_PATH    --max_det $MAX_DETECT

# python validation_YOLO.py \
#     -d $DATA_PATH   -n $DATA_NAME \
#     -p $MODEL_PATH  -m "ABLATION/yolov12x_SUWON_DATASET_VER02-01" \
#     -c $CUDA_DEVICE -i $IMAGE_SIZE  -b $BATCH_SIZE_YOLO11x \
#     --conf $CONF_SCORE  --iou $IOU_DETECT    --split $SPLIT_PATH    --max_det $MAX_DETECT
